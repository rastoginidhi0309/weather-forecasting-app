document.addEventListener("DOMContentLoaded", function () {
  ...
  // Basic calculation
  document
    .getElementById("calculate-basic")
    .addEventListener("click", function () {
  ...
  document
    .getElementById("calculate-appliance")
    .addEventListener("click", function () {
  ...
  document
    .getElementById("calculate-advanced")
    .addEventListener("click", function () {
  ...
  function calculateAndDisplay(kwh, rate, days, taxRate = 0) {
    ...
    document.getElementById("daily-kwh").textContent = `${dailyKwh.toFixed(
      2
    )} kWh`;
    document.getElementById("hourly-kwh").textContent = `${hourlyKwh.toFixed(
      3
    )} kWh`;
